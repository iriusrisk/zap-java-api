...
public class ZAProxyScanner implements ScanningProxy, Spider, Authentication {
    ...
    */
   @Override public void scanAsUser(String url, String contextId, String userId, boolean recurse)
         throws ProxyException {
      try {
   ...
   public void setAuthenticationMethod(String contextId, String authMethodName,
      ...
      try {
         clientApi.authentication
               .setAuthenticationMethod(apiKey, contextId, authMethodName, authMethodConfigParams);
      } catch (ClientApiException e) {
         e.printStackTrace();
         throw new ProxyException(e);
      }
   ...
   public void setAuthenticationCredentials(String contextId, String userId,
      ...
      try {
         clientApi.users.setAuthenticationCredentials(apiKey, contextId, userId,
   ...
   public void setSessionManagementMethod(String contextId, String sessionManagementMethodName,
      ...
      try {
         clientApi.sessionManagement
               .setSessionManagementMethod(apiKey, contextId, sessionManagementMethodName,
                     methodConfigParams);
      } catch (ClientApiException e) {
         e.printStackTrace();
         throw new ProxyException(e);
   ...
   public void loadScript(String scriptName, String scriptType, String scriptEngine,
      ...
      try {
         clientApi.script
               .load(apiKey, scriptName, scriptType, scriptEngine, fileName, scriptDescription);
      } catch (ClientApiException e) {
         e.printStackTrace();
         throw new ProxyException(e);
      }
